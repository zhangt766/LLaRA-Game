...
score_instruct = """You are a system that recommends books based on user's reading history. Please evaluate the similarity between each reading history in the candidate list and the single target reading history. Rate the similarity on a scale from 1 to 10, where 1 is not similar at all and 10 is very similar.\n
