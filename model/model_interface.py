...
score_instruct = """You are a system that recommends games based on play history. Please evaluate the similarity between each play history in the candidate list and the single target play history. Rate the similarity on a scale from 1 to 10, where 1 is not similar at all and 10 is very similar.

Please output the similarity ratings in JSON format. Here is the format:
{
    "Play History 1": score,
}
\n"""
...
reco_prompt_history = """Similar user {i}: He/She has played games {SimilarHistory}. Based on this, He/She will likely choose {SimilarChoice} to play next. \n"""
